...
func createPost(dbConn *sql.DB) {
	...
	stmt.Exec("3", "Gunta", "Testing and debugging front-end code with Jest", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("4", "Gunta", "The benefits of using CSS preprocessors such as SASS or LESS", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("5", "Gunta", "How to implement lazy loading for images and videos", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("6", "Gunta", "Optimizing website performance with lazy loading, compression and minification", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("7", "Gunta", "Building interactive user interfaces with JavaScript and jQuery", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("8", "Gunta", "A comprehensive guide to React and its features", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("9", "Gunta", "State management in React using Redux and its alternatives", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
	stmt.Exec("10", "Gunta", "Creating animations and transitions with CSS and JavaScript", "Responsive websites are amazing!", "/image/path", "2022-09-01 10:30:22")
}
